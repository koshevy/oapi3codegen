 ...
 */
@Injectable()
export class UpdateListItemService extends ApiService<
  UpdateListItemResponse,
  UpdateListItemRequest,
  UpdateListItemParameters
> {
  ...
  protected get schema(): ApiSchema {
    return {
      ...
      request: {
        'application/json': {
          $ref:
            'schema.439faa7fa9bc54f3f56885#/components/schemas/ToDosItemBlank'
        }
      },
      response: {
        '200': {
        ...
        '409': {
          'application/json': {
            $ref:
              'schema.439faa7fa9bc54f3f56885#/components/schemas/HttpErrorConflict'
          }
        },
        '500': {
          'application/json': {
