...
import { GetListsParameters, GetListsResponse } from '../typings';
// Schemas
 ...
 */
@Injectable()
export class GetListsService extends ApiService<
  GetListsResponse,
  null,
  GetListsParameters
> {
      ...
      response: {
        '200': {
          'application/json': {
            ...
            items: {
              $ref:
                'schema.9d7750cb74ffbfbff885ab#/components/schemas/ToDosList'
            }
          }
        },
        '400': {
