 ...
 * mocks in parameters, body ot responses
 *
...
export abstract class BaseConvertor {
    ...
    //     this._structure = fsExtra.readJsonSync(fileName) as OApiStructure;
    //
    ...
    protected _pickApiMethodResponses(
        ...
        _.each(responses, (
            ...
            _.each(contentSchemes, (
                ...
                if (Math.round(Number(code) / 100) === 2) {
